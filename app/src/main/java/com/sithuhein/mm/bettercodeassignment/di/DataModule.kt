...
import com.sithuhein.mm.data.repository.LaunchesDataRepositoryImpl
...
abstract class DataModule {
    ...
    @Binds
    abstract fun provideLaunchListDataRepository(impl : LaunchesDataRepositoryImpl) : LaunchesListDataRepository
}
